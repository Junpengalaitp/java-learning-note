package com.junpenghe.reflection.api.test.test;

import com.junpenghe.reflection.api.test.api.ClothingProduct;
...
public class ProductTest {
    ...
    public static void testSetters(Class<?> dataClass) {
        ...
        for (Field field : fields) {
            String setterName = "set" + capFirstChar(field.getName());
            Method setterMethod;
            try {
    ...
    public static void testGetters(Class<?> dataClass) {
        ...
        for (Field field : fields) {
            String getterName = "get" + capFirstChar(field.getName());
            ...
            if (!getter.getReturnType().equals(field.getType())) {
                throw new IllegalStateException(String.format("Getter method: %s() has return type %s but expected %s", getter.getName(), getter.getReturnType().getTypeName(), field.getType().getTypeName()));
            }
    ...
    public static String capFirstChar(String fieldName) {
