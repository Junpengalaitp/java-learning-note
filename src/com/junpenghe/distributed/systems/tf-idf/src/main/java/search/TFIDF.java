...
public class TFIDF {
    ...
    public static Map<Double, List<String>> getDocumentsSortedByScore(List<String> terms, Map<String, DocumentData> documentResults) {
        NavigableMap<Double, List<String>> scoreToDocuments = new TreeMap<>();
    ...
    private static void addDocumentScoreToTreeMap(NavigableMap<Double, List<String>> scoreToDoc, double score, String document) {
